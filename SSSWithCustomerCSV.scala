...
https://spark.apache.org/docs/2.1.3/structured-streaming-programming-guide.html
...
object SSSWithCustomerCSV extends App {
	...
	val query = filterDF.writeStream
						.format("console") 
						// to print on console =>  can be "parquet","orc", "json", "csv", etc. 
						//.option("path", "path/to/destination/dir") is required
						// .option("checkpointLocation", "path/to/checkpoint/dir") --> for checkpointing WAL
